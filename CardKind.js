...
function getDefaultCards() {
    return [
        ...
        { "id": "card0", "x": 0, "y": 0, "label": "定义函数", "type": "定义函数", "nodes": [{ "type": "out", "level": 0, "enumType": "call", "label": "call", "color": "#fff", "multiConnected": 1 }], "titleBarColor": ["#84fab0", "#8fd3f4"] },
        ...
        { "id": "card0", "x": 0, "y": 0, "label": "访问数组", "type": "访问数组", "nodes": [{ "type": "out", "level": 0, "enumType": "double", "label": "数组名", "color": "#fff", "multiConnected": 1 }, { "type": "in", "level": 0, "enumType": "double", "label": "变量", "color": "#fff", "multiConnected": 1 }, { "type": "out", "level": 1, "enumType": "double", "label": "数组索引", "color": "#fff", "multiConnected": 1 }], "titleBarColor": ["#84fab0", "#8fd3f4"] },
        ...
        { "id": "card0", "x": 0, "y": 0, "label": ">=", "type": ">=", "nodes": [{ "type": "in", "level": 0, "enumType": "比较符", "label": "比较符", "color": "#fff", "multiConnected": 1 }], "titleBarColor": ["#fddb92", "#d1fdff"] },
        { "id": "card0", "x": 0, "y": 0, "label": "<=", "type": "<=", "nodes": [{ "type": "in", "level": 0, "enumType": "比较符", "label": "比较符", "color": "#fff", "multiConnected": 1 }], "titleBarColor": ["#fddb92", "#d1fdff"] },
        { "id": "card0", "x": 0, "y": 0, "label": "取地址&", "type": "取地址&", "nodes": [{ "type": "out", "level": 0, "enumType": "double", "label": "变量", "color": "#fff", "multiConnected": 1 }, { "type": "in", "level": 0, "enumType": "double", "label": "变量", "color": "#fff", "multiConnected": 0 }], "titleBarColor": ["#84fab0", "#8fd3f4"] },
        { "id": "card0", "x": 0, "y": 0, "label": "解地址*", "type": "解地址*", "nodes": [{ "type": "out", "level": 0, "enumType": "double", "label": "变量", "color": "#fff", "multiConnected": 1 }, { "type": "in", "level": 0, "enumType": "double", "label": "变量", "color": "#fff", "multiConnected": 0 }], "titleBarColor": ["#84fab0", "#8fd3f4"] },
